...
def add_generation_options(parser):
    ...
    group.add_argument(
        ...
        default=60,
        type=int,
        help="The number of frames considered (overrided if duration mode is chosen)",
    )
    ...
    group.add_argument(
        "--no-vertstrans", dest="vertstrans", action="store_false", help="Do not add the vertex translations"
    )
    ...
    group.add_argument(
        "--mode",
        default="gen",
        choices=["interpolate", "gen", "duration", "reconstruction"],
